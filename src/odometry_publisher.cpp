...
void OdometryPublisher::motor_to_speed(double& m1, double& m2, double& m3, double& m4, geometry_msgs::Twist& msg)
{
//电机速度转角速度线速度；逆运动学
...
int main(int argc, char **argv)
{
  ...
  //OdometryPublisher car2_odom("/car2/base_footprint", "car2speed", -1, 0, 0);
  while(ros::ok())
  {
    ros::spinOnce();
    loop_rate.sleep();
